...
function readJavaVersionMaven(file) {
    ...
    let propertyMap = new Map((_c = (_b = getNodeByPath(document, ['properties'], 0)[0]) === null || _b === void 0 ? void 0 : _b.children.filter(node => node.type === 'element')) === null || _c === void 0 ? void 0 : _c.map(node => [node.name, node.val]));
    let javaVersions = (_e = (_d = getNodeByPath(document, ['build', 'plugins', 'plugin|artifactId=maven-compiler-plugin', 'configuration'], 0)[0]) === null || _d === void 0 ? void 0 : _d.children.filter(node => node.type === 'element')) === null || _e === void 0 ? void 0 : _e.map(node => { var _b; return (_b = node.val) === null || _b === void 0 ? void 0 : _b.trim(); });
    let result = null;
...
function matchFilter(node, filter) {
    ...
    return childNode && ((_b = childNode[0]) === null || _b === void 0 ? void 0 : _b.val) === kv[1];
}
